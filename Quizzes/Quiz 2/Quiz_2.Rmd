...
$\binom{n}{k} p^{k} (1 - p)^{n - k}$, where $p = \frac{1}{2}$, $n = 5$ and $k = 4$ or $k = 5$ for 4 or 5 heads, respectively, such that
...
**With the Law of Large Numbers (LLN), the sample mean should be near the population mean of 0.5.**

Alternatively, simulate this problem in R and generate 1000 random numbers from this normal distribution to then calculate their mean:
